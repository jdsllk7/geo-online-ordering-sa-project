    ...
    <main>
        ...
        <section class="contact-section">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-12">
                        <h2 class="contact-title">Order Online</h2>
                    </div>
                    <div class="col-lg-8">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        <textarea class="form-control w-100" name="message" id="message" cols="30" rows="9" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter address'" placeholder=" Enter Message"></textarea>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <input class="form-control" name="subject" id="subject" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter phone number'" placeholder="Enter Subject">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-group mt-3">
                               <a href="admin/gps.html"> <button class="button button-contactForm boxed-btn">Send Gps location</button></a>
                            </div>
                    </div>
